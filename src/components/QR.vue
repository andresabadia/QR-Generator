<template>
  <div class="qr">    
    <div class="dont-print">
      ...
      <div class="keychain-properties">Logo width and height (cm) <input type="number" step="0.1" v-model="logoWidth"></div>
      ...
      <div class="keychain" :style="'width:' + keychainWidth + 'cm; height:' + keychainHeight + 'cm;'">
        <div class="qr-code-container" :style="'margin-bottom:' + marginButtom + 'cm'">
        ...
        <div class="keychain-string" :style="'font-size:' + stringSize + 'pt'">ID: 9999</div>
    ...
    <div class="print-me">
      <div class="keychain" :style="'width:' + keychainWidth + 'cm; height:' + keychainHeight + 'cm;'" v-for="code in codes" :key="code">
        ...
        <div class="keychain-string" :style="'font-size:' + stringSize + 'pt'">ID: {{code}}</div>
        <div class="keychain-title" :style="'font-size:' + titleSize + 'pt; margin-bottom:' + titleMarginBottom + 'cm'" >{{title}}</div>
      </div>
    </div>
  </div>
